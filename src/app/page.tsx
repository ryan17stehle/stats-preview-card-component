...
export default function Home() {
  return (
    <main 
      className={`min-w-[280px] max-w-[425px] bg-violet rounded-lg xl:flex xl:max-w-[1110px]`}
    >
      <section className="xl:order-2">
        <Image
          src={desktopImg}
          alt="people working in an office"
          className="hidden mb-8 max-w-full rounded-t-lg mix-blend-multiply opacity-75 bg-purple
          xl:block xl:h-full"
        />
        <Image
          src={mobileImg}
          alt="people working in an office"
          className="mb-8 block max-w-full rounded-t-lg mix-blend-multiply opacity-75 bg-purple
          xl:hidden"
        />
      </section>
      <section className="grid place-items-center xl:order-1 xl:text-left">
        <h1 className="text-white text-lg font-bold text-center mb-4 w-4/6">
